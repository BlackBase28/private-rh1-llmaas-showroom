...
The TAM Day extension adds an enterprise remediation scenario to the base workshop.
After completing the core modules, you will investigate a broken authorization policy, use RHOAI and MCP tools to determine the root cause, fix the application with Cline, and use Ansible Automation Platform to deploy and validate the remediation.

xref:module-09-tam-day-remediation.adoc#tam-day-remediation[Start the TAM Day broken authorization remediation lab].
